...
const BS = {
  note :{font:{sz:9,  color:{rgb:"595959"}}, alignment:{horizontal:"left", vertical:"center"}},
  title:{font:{sz:15, bold:true}, alignment:{horizontal:"center", vertical:"center"}, border:__ALL},
  head :{font:{sz:10, bold:true}, alignment:{horizontal:"center", vertical:"center", wrapText:true},
         fill:{patternType:"solid", fgColor:{rgb:"EDF2F7"}}, border:__ALL},
  sect :{font:{sz:11, bold:true}, alignment:{horizontal:"left", vertical:"center"}},
  cell :{font:{sz:10}, alignment:{horizontal:"center", vertical:"center", wrapText:true}, border:__ALL},
  cellL:{font:{sz:10}, alignment:{horizontal:"left", vertical:"center", wrapText:true}, border:__ALL},
  num  :{font:{sz:10}, alignment:{horizontal:"right", vertical:"center"}, border:__ALL, numFmt:"#,##0"},
  dist :{font:{sz:10}, alignment:{horizontal:"right", vertical:"center"}, border:__ALL, numFmt:"#,##0.0"},
  foot :{font:{sz:10, bold:true}, alignment:{horizontal:"center", vertical:"center"},
         fill:{patternType:"solid", fgColor:{rgb:"E7E6E6"}}, border:__ALL},
  footV:{font:{sz:10, bold:true}, alignment:{horizontal:"right", vertical:"center"}, border:__ALL, numFmt:"#,##0.0"},
...
function makeBookSheet(X, v, rows, from, to){
  ...
  aoa.push([bc("⑬ 업무사용비율 (⑫ ÷ ⑪)",BS.foot), bc("",BS.foot), bc("",BS.foot), bc("",BS.foot), bc("",BS.foot),
            bc("100%",{font:{sz:10,bold:true},alignment:{horizontal:"right",vertical:"center"},border:__ALL}),
  ...
  ws["!merges"] = merges;
  ws["!cols"] = [{wch:15},{wch:12},{wch:9},{wch:14},{wch:14},{wch:11},{wch:12},{wch:13},{wch:26}];
  var hs = [{hpx:18},{hpx:24},{hpx:24},{hpx:8},{hpx:20},{hpx:20},{hpx:20},{hpx:8},{hpx:20},{hpx:22},{hpx:34}];
  for(var i=0;i<rows.length;i++) hs.push({hpx:20});
...
async function dlBook(){
  ...
  X.writeFile(wb, "운행기록부_" + from.replace(/-/g,"") + "-" + to.replace(/-/g,"") + ".xlsx");
}
